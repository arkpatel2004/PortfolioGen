...
def serve_react_app():
    try:
        ...
        return jsonify({'error': 'React app not built yet'}), 404
...
def catch_all(path):
    ...
    # If it's a static file request for React
    if '.' in path and not path.startswith('static/'):
        try:
...
# Add this route after your other routes in app.py
...
if __name__ == '__main__':
    ...
    print(f"🚀 Starting Portfolio Generator Backend on port {port}...")
