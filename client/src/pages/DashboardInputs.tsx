...
const DashboardInputs: React.FC = () => {
  ...
  // Update the portfolioTemplates array:
const portfolioTemplates = [
  {
    id: 1,
    name: 'Modern Developer',
    image: `${API_BASE_URL}/static/image/p1.png`,  // Add API_BASE_URL
  },
  {
    id: 2,
    name: 'Animated Dark',
    image: `${API_BASE_URL}/static/image/p2.png`,  // Add API_BASE_URL
  },
  {
    id: 3,
    name: 'Gradient Dreams',
    image: `${API_BASE_URL}/static/image/p3.png`,  // Add API_BASE_URL
  }
];

// Update the resumeTemplates array:
const resumeTemplates = [
  {
    id: 1,
    name: 'Professional Gradient Corporate',
    image: `${API_BASE_URL}/static/image/r1.png`,  // Add API_BASE_URL
  },
  {
    id: 2,
    name: 'Classic Minimalist Professional',
    image: `${API_BASE_URL}/static/image/r2.png`,  // Add API_BASE_URL
  },
  {
    id: 3,
    name: 'Traditional Academic Professional',
    image: `${API_BASE_URL}/static/image/r3.png`,  // Add API_BASE_URL
  },
  {
    id: 4,
    name: 'Modern Dark Sidebar Resume',
    image: `${API_BASE_URL}/static/image/r4.png`,  // Add API_BASE_URL
  },
  {
    id: 5,
    name: 'Simple Clean Professional',
    image: `${API_BASE_URL}/static/image/r5.png`,  // Add API_BASE_URL
  }
];
  ...
  const handlePreviewPortfolio = async (templateId: number) => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/templates/portfolio/${templateId}`);
  ...
  const handlePreviewResume = async (templateId: number) => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/templates/resume/${templateId}`);
